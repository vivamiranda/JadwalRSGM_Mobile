      ...
      >
        <View style={styles.headerOverlay}>
          ...
          <View style={styles.profileRow}>
            ...
            <View>
              <Text style={styles.headerName}>Siti Amiah</Text>
          ...
          <View style={styles.modeRow}>
            <TouchableOpacity
              ...
              style={[styles.modeBtn, modeKalender === 'hari' && styles.modeBtnActive]}
            >
              <Text style={[styles.modeTxt, modeKalender === 'hari' && styles.modeTxtActive]}>
                1 Hari
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => setModeKalender('minggu')}
              style={[styles.modeBtn, modeKalender === 'minggu' && styles.modeBtnActive]}
            >
              <Text style={[styles.modeTxt, modeKalender === 'minggu' && styles.modeTxtActive]}>
                1 Minggu
              </Text>
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: {
    ...
    color: '#1a1a1a', paddingHorizontal: 16,
    marginVertical: 12,
  },
  card: {
  ...
  avatarSmall: {
    ...
    backgroundColor: '#0d9488', marginRight: 12,
    justifyContent: 'center', alignItems: 'center',
  },
  cardInfo: { flex: 1 },
  cardNameRow: {
